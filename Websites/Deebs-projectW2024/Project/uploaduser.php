...
<button id="back"><a href="homepagepeer.php">HOME</a></button> 
    
 <div class="main">
        
        <div class="register">
        <h2>Enter Details Of New Car</h2>
        <form id="register"  action="uploaduseraction.php" method="POST" enctype="multipart/form-data">    
            ...
            id="name" placeholder="Enter City name" required>
            <br><br>
