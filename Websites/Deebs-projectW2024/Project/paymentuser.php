...
$sql="select *from bookingusers where EMAIL='$email' order by BOOK_ID DESC ";
...
if(isset($_POST['pay'])){
  ...
  if(empty($cardno) || empty($exp) ||  empty($cvv) ){
    ...
    $sql2="insert into paymentuser (CARD_NO,EXP_DATE,CVV,PRICE) values('$cardno','$exp',$cvv,$price)";
...
?>
    ...
    <div class="card">
      <form method="POST">
        ...
        <button class="btn"><a href="cancelbookinguser.php">CANCEL</a></button>
        <script>
