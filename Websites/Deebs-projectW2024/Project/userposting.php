...
// Prepare SQL query to fetch cars posted by the current user
$query = "SELECT uc.* 
          FROM usercars uc
...
<div class="hai">
        ...
        <div>
            ...
            <button class="add"><a href="uploaduser.php">+ ADD CARS</a></button>
            <div>
                <div>
                ...
                <tr  class="active-row">
                    ...
                    ?></php></td>
                    <td><button type="submit" class="but" name="approve"><a href="deletecaruser.php?id=<?php echo $res['CAR_ID']?>">DELETE CAR</a></button></td>
