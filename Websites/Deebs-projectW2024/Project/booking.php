...
<?php 
    ...
    ?>
       ...
       <div class="hai">
        ...
        <form id="register" method="POST"  >
            ...
            id="dfield" min='1899-01-01'   placeholder="ENTER THE DATE FOR BOOKING">
            <br><br>
            ...
            id="name" placeholder="Enter Your return branch">
            <br><br>
            ...
            <br><br>
            <label><input type="checkbox" name="gps" id="gps"> GPS(+100$)</label>
            <br>
            ...
            <div class="receipt">
                ...
                <div id="priceDetails">
                    ...
                    <p>GPS: $<span id="gpsPrice">0</span></p>
        ...
        <?php
         ...
         $carid=$_GET['id'];
        $sql_feedback = "SELECT * FROM feedback WHERE carid = $carid";
    ...
    function updatePrice() {
        ...
        var gpsPrice = document.getElementById('gps').checked ? 100 : 0;
