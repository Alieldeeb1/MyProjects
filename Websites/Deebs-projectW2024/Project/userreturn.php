...
$carid=$_GET['id'];
$book_id=$_GET['bookid'];
$sql2="SELECT *from bookingusers where BOOK_Id=$book_id";
...
if($res['AVAILABLE']=='Y')
{
    ...
    $sql4="UPDATE usercars SET AVAILABLE='Y', branch='$res2[DESTINATION]' WHERE CAR_ID=$res[CAR_ID]";
    $query2=mysqli_query($con,$sql4);
    // Update the booking table to set BOOK_STATUS to 'RETURNED'
    $sql5="UPDATE bookingusers SET BOOK_STATUS='RETURNED' WHERE BOOK_ID=$res2[BOOK_ID]";
