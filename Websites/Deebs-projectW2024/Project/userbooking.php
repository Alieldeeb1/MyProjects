...
// Prepare the SQL query with a WHERE clause to filter by user email
$query = "SELECT * FROM bookingusers WHERE owneremail = '$user_email' ORDER BY BOOK_ID DESC";
...
<div class="hai">
        <div class="navbar">
            ...
            <div class="menu">
                ...
                <li><a href="userbooking.php">BOOKING REQUEST</a></li>
        ...
        <div>
            ...
            <div>
                ...
                <tr  class="active-row">
                    ...
                    <td><button type="submit"  class="but"  name="approve"><a href="approveuser.php?id=<?php echo $res['BOOK_ID']?>">APPROVE</a></button></td>
                    <td><button type="submit" class="but" name="approve"><a href="userreturn.php?id=<?php echo $res['CAR_ID']?>&bookid=<?php echo $res['BOOK_ID']?>">RETURNED</a></button></td>
                </tr>
               <?php } ?>
                </tbody>
                </table>
